// from @hughsk: https://github.com/hughsk/glsl-dither/blob/master/4x4.glsl
...
void main() {
    ...
    if(ditherMode == 0) finalColor = dither2x2(uvPixel, texColor);
    else if(ditherMode == 1) finalColor = dither4x4(uvPixel, texColor);
    else if(ditherMode == 2) finalColor = dither8x8(uvPixel, texColor);
