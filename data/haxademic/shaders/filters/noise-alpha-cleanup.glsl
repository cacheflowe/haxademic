// Cleans up noisy pixels that are off on their own, and hopefully fades off the edges of opaque pixels
// This can be useful after a chromekey step
...
uniform float neighborAlphaCutoff = 0.5;
...
void main() {
    ...
    if(neighborsAlpha > neighborAlphaCutoff) {
        // fade out at edges
        colorOrig.a = remap(neighborsAlpha, 1., neighborAlphaCutoff, 1., 0.); 
    } else {
        // or blank out if pixels are clearly off on their own
        colorOrig.a = 0;
    }
