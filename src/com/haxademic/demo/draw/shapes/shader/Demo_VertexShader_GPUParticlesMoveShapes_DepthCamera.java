...
public class Demo_VertexShader_GPUParticlesMoveShapes_DepthCamera 
extends PAppletHax {
	...
	protected void firstFrame() {
		...
		UI.addToggle(TEXTURE_MODE, false, false);
...
//				PShape shape = PShapeUtil.createTexturedRect(shapeSize, shapeSize, gridX, gridY, 0, DemoAssets.particle());
		...
		polygonShader = new PShaderHotSwap(
			FileUtil.getPath("haxademic/shaders/vertex/mesh-3d-depth-vert.glsl"),
			FileUtil.getPath("haxademic/shaders/vertex/mesh-3d-depth-frag.glsl") 
		);
	...
	protected void drawApp() {
		...
		DebugView.setTexture("realSenseWrapper.getRgbImage()", realSenseWrapper.getRgbImage());
		...
		polygonShader.shader().set("colorMap", realSenseWrapper.getRgbImage());
