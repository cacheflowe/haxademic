...
implements SimpleMidiListener {
	...
	public void drawApp() {
		...
		p.midiState.sendMidiOut(true, 0, LaunchControl.PAD_01, P.round(AudioIn.audioFreq(2) * 150f));
		p.midiState.sendMidiOut(true, 0, LaunchControl.PAD_02, P.round(AudioIn.audioFreq(3) * 150f));
		p.midiState.sendMidiOut(true, 0, LaunchControl.PAD_03, P.round(AudioIn.audioFreq(4) * 150f));
		p.midiState.sendMidiOut(true, 0, LaunchControl.PAD_04, P.round(AudioIn.audioFreq(5) * 150f));
		p.midiState.sendMidiOut(true, 0, LaunchControl.PAD_05, P.round(AudioIn.audioFreq(6) * 150f));
