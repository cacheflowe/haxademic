...
//						_pg.endDraw();
						...
						draw4PointsTriangles(
							new PVector(eA.x*_width, eA.y*_height, 0),
							new PVector(outerX*_width, outerY*_height, 0),
							new PVector(outerXB*_width, outerYB*_height, 0),
							new PVector(eB.x*_width, eB.y*_height, 0),
							_pg
						);
...
//		p.popMatrix();
	...
	public void draw4PointsTriangles( PVector point1, PVector point2, PVector point3, PVector point4, PGraphics shadow ) {
