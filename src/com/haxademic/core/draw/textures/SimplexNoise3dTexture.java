...
public class SimplexNoise3dTexture {
	...
	public void fractalMode(boolean fractalMode) {
		this.update(zoom, rotation, offset.x, offset.y, offset.z, fractalMode);
	}
	...
	public void offsetX(float offsetX) {
		this.update(zoom, rotation, offsetX, offset.y, offset.z, fractalMode);
	}
	
	public void offsetY(float offsetY) {
		this.update(zoom, rotation, offset.x, offsetY, offset.z, fractalMode);
	}
	
	public void offsetZ(float offsetZ) {
		this.update(zoom, rotation, offset.x, offset.y, offsetZ, fractalMode);
	}
	
	public void update(float zoom, float rotation, float offsetX, float offsetY, float offsetZ, boolean fractalMode) {
		this.zoom = zoom;
