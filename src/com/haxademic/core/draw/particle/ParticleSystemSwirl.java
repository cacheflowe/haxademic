...
extends ParticleSystem {
	...
	public void enableUI(boolean saves) {
		usingUI = true;
		P.p.ui.addSlider(MAX_ATTEMPTS, 2000, 10, 5000, 5, saves);
		P.p.ui.addSlider(MAX_LAUNCHES, 8, 1, 100, 1, saves);
		P.p.ui.addSlider(POOL_MAX_SIZE, 10000, 10, 20000, 1, saves);
		P.p.ui.addSlider(SPEED_X_MIN, 0, -5f, 5, 0.01f, saves);
		P.p.ui.addSlider(SPEED_X_MAX, 0.66f, -5, 5, 0.01f, saves);
		P.p.ui.addSlider(SPEED_Y_MIN, 0f, -5f, 5, 0.01f, saves);
		P.p.ui.addSlider(SPEED_Y_MAX, 0.44f, -5, 5, 0.01f, saves);
		P.p.ui.addSlider(GRAVITY_X_MIN, 0, -0.5f, 0, 0.001f, saves);
		P.p.ui.addSlider(GRAVITY_X_MAX, 0.002f, 0, 0.5f, 0.001f, saves);
		P.p.ui.addSlider(GRAVITY_Y_MIN, -0.33f, -0.5f, 0, 0.001f, saves);
		P.p.ui.addSlider(GRAVITY_Y_MAX, 0.12f, 0, 0.5f, 0.001f, saves);
		P.p.ui.addSlider(LIFESPAN_MIN, 10, 10, 50, 1, saves);
		P.p.ui.addSlider(LIFESPAN_MAX, 50, 10, 200, 1, saves);
		P.p.ui.addSlider(ROTATION_MIN, 0, -1, 0, 0.001f, saves);
		P.p.ui.addSlider(ROTATION_MAX, 0.281f, 0, 1f, 0.001f, saves);
		P.p.ui.addSlider(SIZE_MIN, 10, 1, 40, 0.1f, saves);
		P.p.ui.addSlider(SIZE_MAX, 90, 10, 200, 0.1f, saves);
	}
