...
implements IJoystickCollection {
	...
	public DepthCameraOverheadGrid(int cols, int rows, int kinectClose, int kinectFar, int padding, int kinectTop, int kinectBottom, int kinectPixelSkip, int minPixels) {
		super();
