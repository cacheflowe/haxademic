...
//		p.rotateY(p.frameCount/20f);
		p.rotateZ(p.frameCount/20f);
		
		_superForm.update();
		_superForm.drawMesh(p, true, true, true, false, _camPos );
		
		_superForm.a( 5 + P.sin(p.frameCount/120f) * 4f);
		_superForm.b( 15 + P.sin(p.frameCount/130f) * 14f);
		_superForm.m( 15 + P.sin(p.frameCount/150f) * 14f);
		_superForm.n1( 15 + P.sin(p.frameCount/117f) * 14f);
		_superForm.n2( 15 + P.sin(p.frameCount/127f) * 14f);
		_superForm.n3( 5 + P.sin(p.frameCount/143f) * 4f);
	}
