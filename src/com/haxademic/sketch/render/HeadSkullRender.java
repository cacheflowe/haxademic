...
extends PAppletHax {
	...
	public void setup() {
		...
		// controls
		p.ui.addSlider(emissiveMaterial, 13f, 0, 255, 0.5f, false);
		p.ui.addSlider(ambientLight, 24f, 0, 255, 0.5f, false);
		p.ui.addSlider(specularMaterial, 150, 0, 255, 0.5f, false);
		p.ui.addSlider(specularLight, 200, 0, 255, 0.5f, false);
		p.ui.addSlider(shininessVal, 40f, 0, 100, 0.5f, false);
		p.ui.addSlider(lightsFalloffVal, 0.005f, 0, 0.01f, 0.0001f, false);
		p.ui.addSlider(lightsFalloffConstantVal, 0.017f, 0, 2f, 0.01f, false);
		p.ui.addSlider(spotLightConeAngle, 0.2f, 0, P.TWO_PI, 0.01f, false);
