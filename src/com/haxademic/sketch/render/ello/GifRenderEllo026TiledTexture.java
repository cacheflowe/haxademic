...
extends PAppletHax {
	...
	public void setup() {
		super.setup();
		tiledBg = new TiledTexture(p.loadImage(FileUtil.getFile("images/ello-opaque.png")));
	}
...
//		tiledBg.setRotation(P.sin(p.frameCount * 0.01f) * 1f);
//		tiledBg.setOffset(30000f * P.sin(p.frameCount * 0.01f), 10f * P.cos(p.frameCount * 0.01f));
		tiledBg.setSize(120f + 114f * P.sin(progressRads), 120f + 114f * P.sin(progressRads));
		tiledBg.update();
