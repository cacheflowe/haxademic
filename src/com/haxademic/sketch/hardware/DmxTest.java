...
//				outputString += (127+P.sin((200+p.frameCount)/18f)*127) + ",";
				outputString += 255f * p.audioFreq(10) + ",";
				outputString += 255f * p.audioFreq(20) + ",";
				outputString += 255f * p.audioFreq(30) + ",";
				// light 2 rgb
...
//				outputString += (127+P.sin((200+p.frameCount)/8f)*127) + ",";
				outputString += 255f * p.audioFreq(100) + ",";
				outputString += 255f * p.audioFreq(200) + ",";
				outputString += 255f * p.audioFreq(220) + ",";
				// fill in the rest
