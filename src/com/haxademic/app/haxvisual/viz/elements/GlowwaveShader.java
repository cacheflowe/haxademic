...
implements IVizElement  {
	...
	protected void loadShaders() {
		_patternShader = p.loadShader( FileUtil.getHaxademicDataPath() + "haxademic/shaders/textures/glowwave.glsl" ); 
...
//		_kaleido.set("sides", MathUtil.randRange(1, 2));
	...
	public void updateTiming() {
		if( _timingFrame % 4 == 0 ) {
			...
			_timeEaser.setTarget( _timeEaser.value() + 2 );
		} else {
			_brightEaser.setCurrent(0.8f);
			_timeEaser.setTarget( _timeEaser.value() + 0.5f );
		}
