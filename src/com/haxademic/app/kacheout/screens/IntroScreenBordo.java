...
//		_cdTextLoc = new EasingFloat3d( 0, 0, 0, 4 );
		...
		_imgBoardpusherLoc = new EasingFloat3d( 0, 0, 0, 5 );
		...
		// set up keyframes
		_frame1 = 0;
		_frame12 = _frame1 + 120;
		_frame13 = _frame12 + 120;
		_frame14 = _frame13 + 120;
		_frame2 = _frame14 + 120;	// create denver
		_frame3 = _frame2 + 120;	// kacheout
		_frame4 = _frame3 + 90;		// built by
		_frame5 = _frame4 + 90;		// mode set
//		_frame6 = _frame5 + 50;		// cacheflowe
		_frame7 = _frame5 + 80;		// designers
		_frame8 = _frame7 + 20;		// end
		
		
		_imgBordoBello = p.loadImage( "../data/images/kacheout/bb/bordo-bello.png" );
		_imgAirwalk = p.loadImage( "../data/images/kacheout/bb/airwalk.png" );
		_imgMotchka = p.loadImage( "../data/images/kacheout/bb/motchka.png" );
...
//			_cdTextLoc.setTargetY( -p.stageHeight() );
		if( _frameCount == _frame1 ) {
			...
			_imgMotchkaLoc.setTargetY( -p.stageHeight() );
			_imgBoardpusherLoc.setTargetY( 0 );
		} else if( _frameCount == _frame2 ) {
			_imgBoardpusherLoc.setTargetY( -p.stageHeight() );
