...
//		_cameraZFromHeight = (float)_stageHeight * CAMERA_Z_WIDTH_MULTIPLIER;
		...
		float kinectRangeWidth = KinectSize.WIDTH / 2f * KINECT_GAP_PERCENT;
		_player1 = new GamePlay( 0, 0, _gameWidth, new FloatRange( 0, kinectRangeWidth ) );
		_player2 = new GamePlay( 1, _gameWidth, _gameWidth * 2, new FloatRange( KinectSize.WIDTH - kinectRangeWidth, KinectSize.WIDTH ) );
...
//		drawDebug();
	...
	protected void drawDebug() {
		...
		p.fill(255, 255);
		p.noStroke();
		p.rect(0, 0, KinectSize.WIDTH*1.1f, KinectSize.HEIGHT*1.1f);
		p.translate( 0, 0, 100 );
