...
extends PAppletHax {
	...
	protected LinearFloat showHide = new LinearFloat(0, 0.035f);
	...
	protected void setupFirstFrame() {
		...
		float textDepth = 80;
		float textHeight = p.height * 0.45f;
		
		wordGay = textToPShape.stringToShape3d("GAY", textDepth, fontFile);
		...
		wordAF = textToPShape.stringToShape3d("AF", textDepth, fontFile);
...
//		PShapeUtil.centerShape(shape);
		PShapeUtil.scaleShapeToHeight(shape, p.height * 3f);
